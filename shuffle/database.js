const songsByArtist = {
  ...
  "Dua Lipa": [
    ...
    {
      name: "Last Dance",
      youtubeId: "lwZqbQL4H4Q"
    },
    {
      name: "Levitating Featuring DaBaby",
      youtubeId: "TUVcZfQe-Kw"
    },
    {
      name: "Lost In Your Light feat. Miguel",
      youtubeId: "r-AuLm7S3XE"
    },
    {
      name: "Love Again",
...
for (const artist in songsByArtist) {
  totalYouTubeIds += songsByArtist[artist].length;
  totalArtists++;
}

// Update the content of the div with the total YouTube IDs
const totalYouTubeIdsDiv = document.getElementById("totalYouTubeIds");
totalYouTubeIdsDiv.textContent = "Songs: " + totalYouTubeIds;

// Update the content of the div with the total number of artists
const totalArtistsDiv = document.getElementById("totalArtists");
totalArtistsDiv.textContent = "Artists: " + totalArtists;
